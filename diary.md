...
### hostsファイル  
#### 前提知識
「IPアドレス」(https://wa3.i-3-i.info/word172.html)  
コンピュータに割り当てられる住所のような数値の羅列  

「ドメイン名」(https://wa3.i-3-i.info/word1286.html)  
IPアドレスにつけた人間がわかりすい別名  

「DNS」(https://wa3.i-3-i.info/word1287.html)  
IPアドレスとドメイン名の対応を管理する仕組みのこと。IPアドレス←→ドメイン名の翻訳を行う（Domain Name System)  

「DNSサーバ」
DNSのサービスを提供するコンピュータのこと

「ホスト名」
ネットワーク上でコンピュータを識別するための名前
#### hostsファイルについて
ホスト名とIPアドレスの対応付けを書いておくファイルなんだな～
...
# 2019/08/26
## 業務
テストの際、基本設計書や詳細設計書を見て何が正しい仕様なのかをみることはできるようになった
...
フィールドの値にはsetter(),getter()をつかって変更、取得をする。  
酔ってても勉強はできるのでやりたいときにはやったほうがいい。
